...
local function showConfirmationDialog()
	...
	confirmationWindow.BackgroundColor3 = Color3.new(0, 0, 0)
	confirmationWindow.Visible = true
	confirmationWindow.Parent = MainWindow

	local confirmText = Instance.new("TextLabel")
	confirmText.Size = UDim2.new(1, 0, 0.6, 0)
	confirmText.Position = UDim2.new(0, 0, 0, 0)
	confirmText.BackgroundTransparency = 1
	confirmText.Text = "Você tem certeza que quer fechar o Hub?"
	confirmText.TextColor3 = Color3.new(240, 240, 240)
	confirmText.Parent = confirmationWindow
	...
	yesButton.Text = "Sim"
	yesButton.TextColor3 = Color3.new(240, 240, 240)
	yesButton.Parent = confirmationWindow
	...
	noButton.Text = "Não"
	noButton.TextColor3 = Color3.new(240, 240, 240)
	noButton.Parent = confirmationWindow
	...
	yesButton.MouseButton1Up:Connect(function()
		...
		OrionLib:MakeNotification({
			Name = "Hub fechado",
			Content = "Toque em Shift do keyboard para reabrir a interface",
			Time = 4
		})
